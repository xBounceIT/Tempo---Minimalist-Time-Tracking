  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <section className={`bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-opacity ${!formData.enabled ? 'opacity-50 pointer-events-none' : ''}`}>
